...
export default function MovToMp4Page() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`MOV to MP4`} description={t`Convert MOV videos to MP4 for free. No signup, files processed in memory only.`} path="/convert/mov-to-mp4" structuredData={buildToolSchema(t`MOV to MP4`, t`Convert MOV to MP4 for free.`, '/convert/mov-to-mp4')} />
