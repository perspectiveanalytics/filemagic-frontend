  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO
        ...
        description={t`Convert ebooks between EPUB, MOBI, AZW3, PDF, FB2 and more. Free, no signup required.`}
        path="/convert/ebook"
        structuredData={buildToolSchema(t`Ebook Converter`, t`Convert ebooks between EPUB, MOBI, AZW3, PDF and more.`, '/convert/ebook')}
      />
      <Typography component="h1" level="h3" sx={{ mb: 1, fontWeight: 700, letterSpacing: '-0.02em' }}><Trans>Ebook Converter</Trans></Typography>
      <Typography level="body-sm" sx={{ color: 'text.tertiary', mb: 4 }}><Trans>Convert between EPUB, MOBI, AZW3, PDF and more</Trans></Typography>
      ...
      <ToolSEOContent
        howTo={{
          ...
          steps: [
            t`Select the target format — EPUB, MOBI, AZW3, PDF, TXT, FB2, DOCX, or HTML.`,
            t`Upload your ebook file (up to 50 MB).`,
            t`Download the converted ebook instantly.`,
          ],
        }}
        features={[
          { icon: <MenuBookOutlinedIcon />, title: t`Eight Output Formats`, description: t`Convert to EPUB, MOBI, AZW3, PDF, Plain Text, FB2, DOCX, or HTML.` },
          ...
          { icon: <DevicesOutlinedIcon />, title: t`Cross-Device Ready`, description: t`Convert to the right format for any e-reader — Kindle (MOBI/AZW3), Kobo (EPUB), or any PDF viewer.` },
          ...
          { icon: <SecurityOutlinedIcon />, title: t`Privacy First`, description: t`Ebooks are processed in isolated memory and deleted immediately after download.` },
        ]}
        faq={[
          { question: t`What ebook formats can I convert between?`, answer: t`Input formats include EPUB, MOBI, AZW3, AZW, PDF, FB2, TXT, DOCX, HTML, HTM, RTF, ODT, LIT, PDB, CBZ, and CBR. Output formats are EPUB, MOBI, AZW3, PDF, TXT, FB2, DOCX, and HTML.` },
