...
const routeKeywords: Partial<Record<ToolKey, string>> = {
  ...
  'audio-extract': 'video mp4 mkv avi mov audio extract mp3 wav flac extraire music musique son',
  'audio-convert': 'mp3 wav flac m4a aac audio convert format music musique son',
