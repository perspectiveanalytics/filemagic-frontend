...
export default function ImageConvertPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO
        title={t`Image Tools`}
        description={t`Convert HEIC, PNG, JPG, WebP, TIFF, BMP, and SVG images. Crop, resize, export PDF or ICO, and generate favicon packages. Free, no signup.`}
        path="/convert/image"
      ...
      <Typography level="body-sm" sx={{ color: 'text.tertiary', mb: 3 }}><Trans>HEIC, PNG, JPG, WebP, TIFF, BMP, SVG, plus PDF and ICO export</Trans></Typography>
      ...
      <ToolSEOContent
        ...
        features={[
          { icon: <ImageOutlinedIcon />, title: t`Image Conversion`, description: t`Convert HEIC, PNG, JPG, WebP, TIFF, BMP, and SVG images, with PDF and ICO export options.` },
        ...
        faq={[
          { question: t`What image formats are supported?`, answer: t`FileMagic accepts HEIC, HEIF, PNG, JPG/JPEG, WebP, BMP, TIFF, and SVG inputs. You can export common image formats, PDF, or ICO/favicon files depending on the selected mode.` },
          ...
          { question: t`Are my images stored on your servers?`, answer: t`No account or workspace is created for your images. Files are handled in an isolated worker and expire after processing.` },
