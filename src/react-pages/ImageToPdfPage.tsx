...
export default function ImageToPdfPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`Images to PDF`} description={t`Convert one or multiple images into a single PDF document for free. No signup, short-lived processing.`} path="/merge/image-to-pdf" structuredData={buildToolSchema(t`Images to PDF`, t`Convert one or multiple images into a single PDF document for free. No signup, short-lived processing.`, '/merge/image-to-pdf')} />
