...
export default function AudioExtractPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`Extract Audio`} description={t`Extract audio track from video files for free. No signup, short-lived processing.`} path="/convert/audio/extract" structuredData={buildToolSchema(t`Extract Audio`, t`Extract audio track from video files for free. No signup, short-lived processing.`, '/convert/audio/extract')} />
