...
export default function AudioConvertPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`Audio Convert`} description={t`Convert between MP3, WAV, FLAC and AAC for free. No signup, short-lived processing.`} path="/convert/audio" structuredData={buildToolSchema(t`Audio Convert`, t`Convert between MP3, WAV, FLAC and AAC for free. No signup, short-lived processing.`, '/convert/audio')} />
