...
export default function OcrPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`OCR - Text Extraction`} description={t`Extract text from images and PDFs with OCR. Free, no signup, short-lived processing.`} path="/ocr" structuredData={buildToolSchema(t`OCR - Text Extraction`, t`Extract text from images and PDFs with OCR. Free, no signup, short-lived processing.`, '/ocr')} />
      ...
      <ToolSEOContent
        ...
        features={[
          ...
          { icon: <LockOutlinedIcon />, title: t`Private & Secure`, description: t`Files are handled in an isolated sandbox and expire after extraction.` },
