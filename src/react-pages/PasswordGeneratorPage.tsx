  ...
  return (
    ...
    >
      ...
      <Typography level="body-xs" sx={{ color: 'warning.softColor', lineHeight: 1.6, fontStyle: 'italic', opacity: 0.8, mb: 1.5 }}>
        {t`This tool is handy for quick throwaway passwords. Copy the result before leaving the page: nothing is stored, and generated passwords cannot be recovered.`}
      </Typography>
