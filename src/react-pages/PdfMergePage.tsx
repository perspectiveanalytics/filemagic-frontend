...
export default function PdfMergePage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`Merge PDFs`} description={t`Combine multiple PDF files and images into one PDF document for free. No signup, short-lived processing.`} path="/merge/pdf" structuredData={buildToolSchema(t`Merge PDFs`, t`Combine multiple PDF files and images into one PDF document for free. No signup, short-lived processing.`, '/merge/pdf')} />
