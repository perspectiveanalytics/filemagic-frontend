...
export default function PdfExtractImagesPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`Extract Images from PDF`} description={t`Extract up to 200 embedded images from a PDF file for free. Download individually or as ZIP.`} path="/convert/pdf-extract-images" structuredData={buildToolSchema(t`Extract Images from PDF`, t`Extract embedded images from PDF files.`, '/convert/pdf-extract-images')} />
      ...
      <Typography level="body-sm" sx={{ color: 'text.tertiary', mb: 4 }}><Trans>Extract up to 200 embedded images from a PDF file</Trans></Typography>
      ...
      <ToolSEOContent
        howTo={{
          ...
          steps: [
            ...
            t`The tool automatically finds and extracts up to 200 embedded raster images.`,
            t`Preview extracted images with the built-in lightbox viewer.`,
            t`Download images individually or all at once as a ZIP file.`,
          ],
        }}
        features={[
          { icon: <ImageOutlinedIcon />, title: t`Extract Embedded Images`, description: t`Automatically finds and extracts up to 200 embedded raster images from your PDF document.` },
        ...
        faq={[
          ...
          { question: t`Is there a limit on the number of images?`, answer: t`Yes. The extractor returns up to 200 embedded raster images per PDF. The maximum PDF file size is 30 MB.` },
