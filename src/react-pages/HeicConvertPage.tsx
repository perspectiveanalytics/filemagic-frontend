...
export default function HeicConvertPage() {
  ...
  return (
    <Box sx={{ maxWidth: 520, mx: 'auto', width: '100%', py: { xs: 3, md: 4 } }}>
      <SEO title={t`HEIC Convert`} description={t`Convert Apple HEIC images to JPG, PNG, WebP, or TIFF for free. No signup, short-lived processing.`} path="/convert/heic" structuredData={buildToolSchema(t`HEIC Convert`, t`Convert Apple HEIC images to JPG, PNG, WebP, or TIFF for free.`, '/convert/heic')} />
